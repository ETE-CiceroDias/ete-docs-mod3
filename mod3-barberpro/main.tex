...
\AddToShipoutPictureBG*{%
  \AtPageLowerLeft{%
    \IfFileExists{capa-barberpro.png}{%
      \includegraphics[width=\paperwidth,height=\paperheight]{capa-barberpro.png}%
    }{%
      \IfFileExists{../../capa-barberpro.png}{%
        \includegraphics[width=\paperwidth,height=\paperheight]{../../capa-barberpro.png}%
      }{%
        \parbox[b][\paperheight]{\paperwidth}{%
          \vspace*{10cm}\begin{center}{\large\color{gray}[capa-barberpro.png não encontrada]}\end{center}%
        }%
      }%
    }%
  }%
...
% ── METADADOS ────────────────────────────────────────────────
\title{Feedback Avaliativo de Projeto: Projeto Final --- BarberPro}

\author{Profa.\ Samara Silva}
\authornote{Grupo: \textbf{BarberPro} \textperiodcentered\ M\'{o}dulo 3 --- Projeto Final \textperiodcentered\ Avaliado em: 18 de junho de 2026.}
...
\affiliation{%
  \institution{ETE C\'{i}cero Dias}
  \department{Fagner · Israel · Valter · Wallace}
  \city{Recife}
  \state{Pernambuco}
  \country{Brasil}
}
...
\midrule
AT1 --- Desempenho em sala & \statuswarn{Com ressalvas} & \textbf{2,8} & 3,0 \\
AT2 --- Documentação & \statusok{Completo} & \textbf{3,0} & 3,0 \\
AT3 --- Apresentação & \statuswarn{Com ressalvas} & \textbf{3,2} & 4,0 \\
\midrule
\textbf{1ª Nota (AT1+AT2+AT3)} & & \textbf{\color{cred}9,0} & \textbf{10,0} \\
...
\noindent\statuswarn{2,80\,/\,3,00 pts · Com ressalvas}

O desempenho em sala só não foi 100\% por conta das faltas, mas, como a maioria dos membros estava presente, eu coloquei 2,8 para ser justo com os outros grupos que estavam mais constantes --- então o desconto foi pequeno.

\subsection{Documentação}
\noindent\statusok{3,00\,/\,3,00 pts · Completo}

Documentação excelente. Sem ressalvas.

\subsection{Apresentação}
\noindent\statuswarn{3,20\,/\,4,00 pts · Com ressalvas}

Eu entendi o motivo de a apresentação ter sido daquele jeito, mas, para ser justo com os outros grupos com os quais fiz a mesma análise, tirei 0,8 décimos. Ainda assim, os membros não foram prejudicados: todos estão com 9,5.
...
Desenvoltura no discurso & 0,40 & \gcut{0,20} \\
...
Casos de Uso com a solução & 0,25 & \gcut{0,05} \\
...
Documentação e projeto de ótimo nível --- nenhum integrante foi prejudicado. Parabéns pela entrega!
